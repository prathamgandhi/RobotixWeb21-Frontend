...
function Team() {
    ...
    <div className="team-tab">
        ...
        <button className="tablinks" onclick="TeamDomain(event, 'managers')">Managers</button>
        <button className="tablinks" onclick="TeamDomain(event, 'head-coordinator')">Head Coordinator</button>
      </div>
